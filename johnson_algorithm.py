...
if __name__ == '__main__':
    ...
    for i in range(len(tasks)):
        new_result[0].append(str(result[0][i][0]) + '-' + str(result[0][i][1]))
        new_result[1].append(str(result[1][i][0]) + '-' + str(result[1][i][1]))

    print(tabulate(new_result, headers=order, tablefmt='orgtbl'))
